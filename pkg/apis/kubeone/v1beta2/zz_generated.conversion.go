...
func autoConvert_v1beta2_KubeOneCluster_To_kubeone_KubeOneCluster(in *KubeOneCluster, out *kubeone.KubeOneCluster, s conversion.Scope) error {
	...
	if in.HelmReleases != nil {
		...
		*out = make([]kubeone.HelmRelease, len(*in))
		for i := range *in {
			if err := Convert_v1beta2_HelmRelease_To_kubeone_HelmRelease(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
		out.HelmReleases = nil
	}
...
func autoConvert_kubeone_KubeOneCluster_To_v1beta2_KubeOneCluster(in *kubeone.KubeOneCluster, out *KubeOneCluster, s conversion.Scope) error {
	...
	if in.HelmReleases != nil {
		...
		*out = make([]HelmRelease, len(*in))
		for i := range *in {
			if err := Convert_kubeone_HelmRelease_To_v1beta2_HelmRelease(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
